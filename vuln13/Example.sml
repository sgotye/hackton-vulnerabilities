fun main () =
	let
        ...
        SCInt 200, SCInt 200, SCInt 50, SCInt 10217, SCInt 10217, SCInt 10217,
        SCInt 10217, SCTaskStatus GasRequested, SCPaymentType Post ];
        val storage = Option.valOf (get result);
        val context = Context 1337 10217 storage;
        ...
        (*taskCompleted*)
        val params = [SCInt 355, SCInt 200];
        val storage = Option.valOf (get result);
        val context = Context 1000 10217 storage;
        ...
        val params = [SCInt 0];
        val storage = Option.valOf (get result);
        val context = Context 1339 10217 storage;
        val result = Runtime.call 20 context params;
    in
